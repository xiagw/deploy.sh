...
- **Testing Suite**: Unit, functional, and performance tests (project scripts + language test frameworks like phpunit / mvn test / pytest / go test with coverage reports; JMeter `*.jmx` and k6 `tests/perf/*.js` with p95 baseline tracking)
